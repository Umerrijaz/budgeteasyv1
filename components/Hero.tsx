...
// ─── Pillar 3: Static data extracted to module scope ─────────────────────────
// The Product Hunt badge is static markup with no logic. Extracting it as a
// named constant keeps the JSX return lean and gives it a searchable name.
// If the badge URL changes, there is exactly one place to update it.
const PRODUCT_HUNT_BADGE = (
  <a
    ...
    title={`${config.appName} on Product Hunt`}
  >
    {/* Pillar 5: fill-base-content/80 is a DaisyUI semantic token —
        it adapts to light and dark mode automatically without "dark:" prefix */}
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 122 37"
      className="w-32 md:w-36 fill-base-content/80 group-hover:fill-base-content transition-colors"
    ...
    <section className="w-full bg-base-100">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-20 px-8 py-8 lg:py-20">
        ...
        <div className="flex flex-col gap-10 lg:gap-14 items-center justify-center text-center lg:text-left lg:items-start">
          ...
          {/* Social proof badge extracted as a named constant above */}
          {PRODUCT_HUNT_BADGE}
